...
from flask_login import current_user # Adicione este import se já utilizar Flask-Login
...
def add_measurement():
    ...
    # 5. Persistência dos dados com o carimbo e o ID do usuário obrigatório
    new_record = Eu2016(
        ...
        idade=request.form.get('age') or None,
        basal=request.form.get('basal') or None,
        fk_user_id=current_user.id  # Atribui o ID do usuário logado para satisfazer o NOT NULL
    )
